...
ggplot(europe_government_expenditure, aes(x = Country, y = `Percent of GPD spent in Education`, color = factor(Year))) +
  geom_point() +
  scale_color_manual(values = palette) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0)) +
  labs(x = "Country", y = "Percent of GDP spent in Education", title = "Education Expenditure in Europe", color = "Year")
