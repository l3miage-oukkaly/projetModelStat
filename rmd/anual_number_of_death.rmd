...
governmentEducationExpenditure_valmax <- governmentEducationExpenditure_mean %>%
  top_n(5, wt = `Mean_GPD_spent`)

# Filtrer les 5 valeurs minimales
governmentEducationExpenditure_valmin <- governmentEducationExpenditure_mean %>%
  slice_min(`Mean_GPD_spent`, n = 5)
```
