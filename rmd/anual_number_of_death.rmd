...
ggplot(data = pays_h1_death, aes(x = Year, y = `Infectious diseases prop (%)`, group = Country, color = Country)) +
  geom_line() +
...
ggplot(data = pays_combinés_enrolment_ratio, aes(x = Year, y = `Enrolment ratio (%)`, group = Country, color = Country)) +
  geom_line() +
  labs(title = "Enrolment ratio per total population",
       x = "Country",
       y = "Enrolment ratio (%)") +
  theme_minimal() +
 scale_color_manual(values = couleurs)
...
print(waterAcess_minmax$Country)
...
ggplot(pays_combinés_waterAcess, aes(x = Year, y = `Water withdrawal per capita ()`, color = factor(Country))) +
  geom_point() +
  scale_color_manual(values = couleurs) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0)) +
  labs(x = "Year", y = "Water withdrawal per capita", title = "Water withdrawal per total population", color = "Country")
...
ggplot(data = pays_combinés_waterAcess, aes(x = Year, y = `Water withdrawal per capita ()`, group = Country, color = Country)) +
  geom_line() +
  labs(title = "Water withdrawal per capita per country",
       x = "Country",
...
ggplot(data = pays_h3_death, aes(x = Year, y = `Infectious diseases prop (%)`, group = Country, color = Country)) +
  geom_line() +
  labs(title = "Infectious diseases per total number of death",
       x = "Country",
       y = "Infectious diseases prop (%)") +
