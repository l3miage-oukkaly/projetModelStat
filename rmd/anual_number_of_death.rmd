...
Initialement, nous avions prévu de diviser chaque tableau en régions pour afficher nos données dans des graphiques à points. Cependant, après réflexion et plusieurs tentatives infructueuses avec les graphiques de lignes, nous avons décidé d'approfondir nos recherches en nous concentrant sur les 5 pays les plus extrêmes pour chaque variable des tableaux que nous avons utilisés. Nous avons ensuite comparé ces pays sélectionnés à leur taux de mortalité par maladies infectieuses.

Pour faciliter la visualisation et la compréhension de nos analyses, nous avons également choisi de calculer les moyennes de chaque variable pour chaque pays. Cela nous a permis d'avoir un affichage plus simple et concis, et de pouvoir émettre des hypothèses plus facilement.  
...
Une fois trouvés, nous pouvons analyser les données de ces pays à l'aide de graphes à barres.
